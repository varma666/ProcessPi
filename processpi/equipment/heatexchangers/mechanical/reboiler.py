...
"""
Advanced Reboiler Module (TEMA C / Aspen E-shell style)
--------------------------------------------------------
Features:
- Preheating + boiling zones
...
- Rough TEMA sizing
- Non-condensable gas effects (optional)

References:
-----------
- Kern, D.Q. (1950), "Process Heat Transfer"
- Bell, K.J., AIChE 1963
- TEMA Standards, Section 3: Reboilers
...
def _boiling_htc(liquid: MaterialStream, orientation="horizontal"):
    """
    Nucleate boiling HTC approximation
    """
    ...
    g = GRAVITY
    # Simplified Rohsenow-style estimate
    q = 1e4  # heat flux guess
...
def design_reboiler(
    ...
    **kwargs
    ...
    """
    Modular reboiler: preheat + boiling zones with iterative U/LMTD convergence
    including optional non-condensable gas effects.
    """
