...
class Water(Component):
    ...
    _critical_volume = Volume(0.0559472, "m3")  # Placeholder for critical volume per Kmole
    _critical_zc = 0.229  # Placeholder for critical compressibility factor
    _critical_acentric_factor = 0.3449  # Placeholder for critical acentric factor
