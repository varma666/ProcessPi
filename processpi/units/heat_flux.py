...
class HeatFlux(Variable):
    ...
    Default SI unit: W/m² (Watts per square meter)
    ...
    _conversion = {
        ...
        "kW/m²": 1000,
        "W/cm²": 10000,
        "BTU/hr·ft²": 3.1546,  # 1 BTU/hr·ft² ≈ 3.1546 W/m²
        "cal/s·cm²": 41840,    # 1 cal/s·cm² ≈ 41840 W/m²
    }

    def __init__(self, value, units="W/m²"):
        if value < 0:
    ...
    def __add__(self, other):
        ...
        return HeatFlux(round(total, 6), "W/m²")
