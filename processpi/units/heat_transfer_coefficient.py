...
class HeatTransferCoefficient(Variable):
    ...
    Default SI unit: W/m²·K (Watts per square meter-Kelvin)

    Example:
    h = HeatTransferCoefficient(200, "W/m²·K")
    """

    _conversion = {
        "W/m²·K": 1,
        "kW/m²·K": 1000,
        "cal/s·cm²·°C": 41840,          # 1 cal/s·cm²·°C ≈ 41840 W/m²·K
        "BTU/hr·ft²·°F": 5.678263,      # 1 BTU/hr·ft²·°F ≈ 5.678263 W/m²·K
    }
    ...
    def __add__(self, other):
        ...
        return HeatTransferCoefficient(round(total, 6), "W/m²·K")
